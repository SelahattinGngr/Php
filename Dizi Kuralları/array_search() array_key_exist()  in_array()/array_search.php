...
array_key_exist()   :   Dizi içerisinde bulunan anahtar veya anahtarlar dahilinde, belirtilecek olan anahtarın olup olmadığını kontrol etmek için kullanılır.
...
$Sonuc = array_search("cancan", $Degerler); 

echo "girilen elemanın anahtar eğeri : ", $Sonuc;
?>
</body>
</html